      ...
      <div class="signin-signup">
        <form action="#" class="sign-up-form" @submit.prevent="handleRegister">
          ...
          <div class="input-field">
            ...
            <input v-model="form.realName" placeholder="真实姓名（可选）" type="text"/>
          </div>
          <div class="input-field">
            <i>
              <font-awesome-icon icon="fa-solid fa-phone"/>
            </i>
            <input v-model="form.phone" placeholder="手机号（可选）" type="tel"/>
          </div>
          <input :disabled="loading" class="btn" type="submit" value="立即注册"/>
