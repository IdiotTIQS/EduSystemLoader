...
public class EnrollmentController {
    ...
    @GetMapping("/unique")
    public ApiResponse<Enrollment> findUnique(@RequestParam Long classId,@RequestParam Long studentId){log.debug("检查学生是否已加入 classId={} studentId={}", classId,studentId); return ApiResponse.ok(enrollmentService.findUnique(classId,studentId));}
}
